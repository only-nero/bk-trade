...
- `ADMIN_LOGIN_LOCK_SEC` — временная блокировка IP после серии неуспешных входов
...
### Дополнительные UX-улучшения на главной

Добавлен интерактивный блок «Быстрый ориентир по срокам поставки», который помогает клиенту быстрее понять формат и скорость работы до отправки заявки.
